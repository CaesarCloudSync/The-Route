...
export default function NavFooter({style}:any){
    ...
    return(
        <View style={[style,{flexDirection:"row",gap:50,justifyContent:"center"}]}>
            ...
            <TouchableOpacity style={{justifyContent:"center",alignItems:"center"}} onPress={()=>{router.push("/foryou")}}><Ionicons name="people" size={24} color="black" /><Text>For You</Text></TouchableOpacity>
        </View>
    )
}